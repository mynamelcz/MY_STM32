 ...
 *      DEFINES
 *********************/
#define MY_DISP_HOR_RES     LCD_HOR_SIZE
#define MY_DISP_VER_RES     LCD_VER_SIZE
...
#else
    lcd_fill_rect(area->x1,area->y1, area->x2,area->y2, (uint16_t *)color_p);
