...
{                  
    ...
    void (*write_16b)(uint16_t data);
    void (*write_bytes)(uint8_t *buf, uint16_t len);
...
void st7789_fill_rect_buf(st7789_handle_t* handle, uint16_t left, uint16_t top, uint16_t right, uint16_t bottom, uint16_t *color);
